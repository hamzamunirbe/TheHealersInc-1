...
const ConsumerLandingPage = () => {
  return (
    <div className="w-full relative bg-m3-sys-light-on-primary overflow-hidden flex flex-col items-start justify-start tracking-[normal] leading-[normal]">
      ...
      <footer className="self-stretch bg-m3-sys-light-on-primary flex flex-col items-center justify-start py-10 px-5 box-border gap-[32px] max-w-full text-left text-mid text-gray-200 font-web-secondary-underline-subtitle2-dm-sans mq750:gap-[16px] mq450:pt-[26px] mq450:pb-[26px] mq450:box-border">
