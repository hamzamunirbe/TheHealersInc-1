...
const ConsumerPreferences1 = () => {
  ...
  return (
    <div className="w-full relative bg-white overflow-hidden flex flex-col items-start justify-start pt-0 px-0 pb-[75px] box-border gap-[80px] leading-[normal] tracking-[normal] text-center text-lg text-neutral-8 font-web-primary-h3-primary-dm-sans mq750:gap-[40px] mq450:gap-[20px]">
      ...
      <div className="w-[963px] flex flex-row items-start justify-center py-0 px-5 box-border max-w-full">
        <div className="flex flex-row items-start justify-center gap-[56px] max-w-full mq750:flex-wrap mq750:gap-[28px]">
          <div className="w-[180px] flex flex-col items-start justify-start gap-[24px] min-w-[180px] mq750:flex-1">
            <div className="self-stretch rounded-2xl bg-royalblue flex flex-col items-start justify-start pt-2.5 pb-[34px] pr-2.5 pl-[57px] gap-[16px] text-white">
