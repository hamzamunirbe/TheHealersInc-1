...
const ConsumerPreferences4 = () => {
  ...
  return (
    <div className="w-full relative bg-white overflow-hidden flex flex-col items-start justify-start pt-0 px-0 pb-[75px] box-border gap-[80px] leading-[normal] tracking-[normal] mq750:gap-[40px] mq450:gap-[20px]">
      <header className="self-stretch bg-white shadow-[0px_3px_6px_-4px_rgba(0,_0,_0,_0.12),_0px_6px_16px_rgba(0,_0,_0,_0.08),_0px_9px_28px_8px_rgba(0,_0,_0,_0.05)] flex flex-row items-start justify-center py-[22px] px-5 gap-[704px] top-[0] z-[99] sticky border-[1px] border-solid border-gainsboro-100 lg:gap-[352px] mq750:gap-[176px] mq450:gap-[88px]">
        ...
        <div className="w-[756px] flex flex-col items-start justify-start gap-[24px] max-w-full">
          <div className="self-stretch flex flex-row items-start justify-start gap-[56px] max-w-full mq750:gap-[28px]">
            <div className="flex flex-col items-start justify-start gap-[24px] mq750:hidden">
              ...
              <div className="rounded-2xl bg-white shadow-[0px_2px_8px_rgba(0,_0,_0,_0.15)] flex flex-col items-start justify-start py-[34px] px-[23px] gap-[16px]">
          ...
          <div className="self-stretch flex flex-row items-end justify-between gap-[20px] text-white mq450:flex-wrap">
            <div
