...
const ButtonBusinessCard = ({ propDisplay, propMinWidth }) => {
  ...
  return (
    <div className="w-[298px] shadow-[0px_1px_2px_rgba(0,_0,_0,_0.3),_0px_1px_3px_1px_rgba(0,_0,_0,_0.15)] rounded-xl bg-neutral-1 shrink-0 flex flex-row items-start justify-start text-left text-xl text-neutral-10 font-web-primary-h3-primary-dm-sans">
