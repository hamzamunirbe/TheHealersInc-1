...
const ButtonBusinessCard = ({ propDisplay, propMinWidth }) => {
  ...
  return (
    <div className="w-[298px] shadow-[0px_1px_2px_rgba(0,_0,_0,_0.3),_0px_1px_3px_1px_rgba(0,_0,_0,_0.15)] rounded-xl bg-m3-sys-light-on-primary shrink-0 flex flex-row items-start justify-start text-left text-xl text-neutral-10 font-web-secondary-underline-subtitle2-dm-sans">
      <div className="flex-1 flex flex-col items-center justify-start">
        ...
        <div className="self-stretch flex flex-row items-start justify-start py-6 px-4 gap-[16px] text-sm text-neutral-8 font-components-helper-text">
          ...
          <div className="overflow-hidden flex flex-row items-center justify-start gap-[8px] text-base text-neutral-10">
            ...
            <img className="bg-hitbox-1000 overflow-hidden flex flex-col items-center justify-center" />
          </div>
        </div>
      </div>
    </div>
