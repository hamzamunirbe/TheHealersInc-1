...
const Component = () => {
  ...
  return (
    <div className="w-[300px] flex flex-row items-start justify-between pt-5 pb-[19px] pr-6 pl-[42px] box-border relative gap-[20px] text-center text-base text-neutral-8 font-web-primary-h3-primary-dm-sans mq450:pl-5 mq450:box-border">
      <div className="h-[50px] w-full absolute !m-[0] top-[calc(50%_-_25px)] right-[0px] left-[0px] rounded-13xl bg-neutral-1 box-border border-[2px] border-solid border-whitesmoke-500" />
      <div
