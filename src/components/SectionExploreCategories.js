const SectionExploreCategories = () => {
  return (
    <section className="self-stretch flex flex-col items-start justify-start py-14 px-[100px] box-border gap-[24px] max-w-full text-left text-13xl text-character-title-85-700 font-web-secondary-underline-subtitle2-dm-sans mq750:py-9 mq750:px-[50px] mq750:box-border mq450:pl-5 mq450:pr-5 mq450:box-border">
      ...
      <div className="self-stretch overflow-x-auto flex flex-row flex-wrap items-start justify-start gap-[32px_30px] min-h-[332px] max-w-full text-center text-m3-sys-light-on-primary">
